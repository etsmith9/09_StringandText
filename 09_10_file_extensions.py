...
"operators.pdf".endswith("pdf") #true
"snowfall.jpg".endswith("pdf") #false
"uncle-joes-wedding.doc".endswith("pdf") #false
"invitation.pdf".endswith("pdf") #true
file_4.endswith("pdf")  #true